    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex justify-between items-center flex-wrap gap-4">
            ...
            <div class="flex gap-3">
                <a href="{{ route('maintenance.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm hover:bg-blue-700 transition flex items-center gap-2">
                        ...
                        <tr class="hover:bg-gray-50 view-details-btn" data-id="{{ $record->id }}">
                            ...
                            <td class="px-6 py-4 text-sm text-center">
                                <div class="flex gap-2 justify-center">
                                    ...
                                    <a href="{{ route("maintenance.dispatch.download", $record->id) }}" class="text-orange-600 hover:text-orange-800" title="Download Dispatch Note">
