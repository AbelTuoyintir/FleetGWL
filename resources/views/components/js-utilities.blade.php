{{-- resources/views/components/js-utilities.blade.php --}}
<style>
    @keyframes slideIn {
    ...
    let notification = $(`
        <div class="fixed top-4 right-4 z-50 animate-slide-in">
            <div class="px-4 py-3 rounded-lg shadow-lg flex items-center gap-3 ${
                ...
                <button onclick="$(this).closest('.fixed').remove()" class="ml-4 text-white hover:text-gray-200" aria-label="Dismiss notification" title="Dismiss" type="button">
