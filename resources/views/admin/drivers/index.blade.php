                        ...
                        @forelse($drivers as $driver)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($driver->license_number)
                                        <div class="flex items-center gap-1.5">
                                            <span class="text-gray-800 font-mono select-all">{{ $driver->license_number }}</span>
                                ...
                                <td>
                                    @if($driver->vehicle)
                                        <div class="flex items-center gap-1.5">
                                            <span class="font-medium font-mono select-all">{{ $driver->vehicle->registration_number }}</span>
                                        ...
                                        <p class="text-xs text-gray-500 mt-0.5">{{ $driver->vehicle->make }} {{ $driver->vehicle->model }}</p>
...
if (!$('#palette-animation-styles').length) {
    $('<style id="palette-animation-styles">')
        .prop('type', 'text/css')
        .html(`
            @keyframes slideIn {
