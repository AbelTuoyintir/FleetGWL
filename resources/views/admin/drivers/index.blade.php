                                ...
                                <td>
                                    <div class="flex items-center gap-2">
                                        ...
                                        @if($driver->license_number)
                                            <button onclick="copyToClipboard('{{ $driver->license_number }}', 'License number')" class="text-gray-400 hover:text-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded p-0.5 transition" title="Copy License Number" aria-label="Copy License Number">
