            ...
            <div>
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-2xl font-bold text-gray-800 flex items-center gap-2">
                        ...
                        <button onclick="copyToClipboard(@js($vehicle->registration_number), 'Registration number')" class="text-gray-400 hover:text-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded p-0.5 transition" title="Copy Registration Number" aria-label="Copy Registration Number">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="info-row">
                                ...
                                <span class="info-value flex items-center gap-2">
                                    ...
                                    <button onclick="copyToClipboard(@js($vehicle->chassis_number), 'Chassis Number')" class="text-gray-400 hover:text-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded p-0.5 transition" title="Copy Chassis Number" aria-label="Copy Chassis Number">
                            ...
                            <div class="info-row">
                                ...
                                <span class="info-value flex items-center gap-2">
                                    ...
                                    <button onclick="copyToClipboard(@js($vehicle->engine_number), 'Engine Number')" class="text-gray-400 hover:text-blue-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded p-0.5 transition" title="Copy Engine Number" aria-label="Copy Engine Number">
                                        <i class="far fa-copy text-xs"></i>
                                    </button>
                                    @endif
                                </span>
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-medium flex items-center gap-2">
                                    ...
                                    <button onclick="copyToClipboard(@js($document->document_number), 'Document Number')" class="text-gray-400 hover:text-blue-600 transition-colors" title="Copy Document Number" aria-label="Copy Document Number">
                                        <i class="far fa-copy text-xs"></i>
                                    </button>
                                    @endif
                                </span>
